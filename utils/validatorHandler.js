...
module.exports = {
    ...
    ChangePasswordValidator: [
        body('oldpassword')
            .notEmpty().withMessage("Mat khau cu khong duoc rong"),
        body('newpassword')
            .notEmpty().withMessage("Mat khau moi khong duoc rong")
            .isStrongPassword(options.password)
            .withMessage(`password dai it nhat ${options.password.minLength} ki tu, trong do co it nhat ${options.password.minNumbers} so ${options.password.minUppercase} chu hoa ${options.password.minLowercase} chu thuong ${options.password.minSymbols} ki tu dac biet`),
    ],
